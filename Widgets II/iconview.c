...
GtkTreeModel *init_model(void) {
	...
	p1 = gdk_pixbuf_new_from_file("redrock.jpg", &err); 
	p2 = gdk_pixbuf_new_from_file("redrock.jpg", &err);
	p3 = gdk_pixbuf_new_from_file("redrock.jpg", &err);
	p4 = gdk_pixbuf_new_from_file("redrock.jpg", &err);
